  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
      <div className="relative w-[90%] max-w-5xl flex flex-col md:flex-row justify-between gap-6">
        ...
        <div className="w-full md:w-[60%] flex flex-col justify-start" style={{ marginTop: "20%" }}>
          <h1 className="text-4xl font-bold" style={{ marginLeft: "-20px" }}>
            Payment Confirmation
          </h1>
          <p className="text-gray-400 mb-8" style={{ marginLeft: "-20px" }}>
            Please Confirm Your Purchase Items Before Proceeding with your Payment.
          </p>
        </div>

       
        <div className="relative w-full md:w-[50%]" style={{ marginTop: "20%" }}>
          ...
          >
            ...
            <div className="flex justify-between mb-4">
              ...
              <span className="text-lg">{bookingData?.planType || "Monthly"}</span>
            </div>
            <div className="flex justify-between mb-4">
              <span className="text-lg">Package Amount</span>
              <span className="text-lg">₹ {bookingData?.amount || "19999"}</span>
            </div>

           
            <hr className="border-white border-4" style={{marginTop:"25%"}} />

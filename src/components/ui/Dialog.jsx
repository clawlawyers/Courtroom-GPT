...
const Dialog = ({
  ...
  return (
    <div className="fixed inset-0 w-full flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="bg-gradient-to-r from-[#0e1118] to-[#008080] w-2/4 max-w-2/4 border border-white rounded-md p-4 h-max relative">
        {/* Close Button */}
        ...
        <div className="text-center">
          ...
          {text && (
            <textarea
              className="w-full h-96 p-2.5 mb-4 text-black rounded-md resize-none"
              value={inputText}

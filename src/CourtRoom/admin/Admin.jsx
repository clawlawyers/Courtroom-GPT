...
const Admin = () => {
  ...
  return (
    <section className="h-screen w-full flex flex-row justify-center items-center gap-5 p-5 ">
      <div className="w-2/12 flex flex-col h-2/3 justify-center gap-4  ">
        <h1 className="w-full text-2xl text-center bg-teal-500 p-2 rounded-md shadow-md shadow-neutral-900">
          Courtroom Users
        </h1>
        <h1 className="w-full text-center text-2xl p-2 rounded-md ">Time Slots</h1>
      </div>
      ...
      <div className="flex flex-col  justify-center h-screen w-full items-center">
        <div className="flex flex-col  rounded-lg h-3/4 bg-black/30 w-2/3 gap-3 p-3 shadow-md">
          {userAddDialog && <UserDialog onClose={handleClose} />}
          <div className="flex flex-row w-full justify-between gap-2 items-start">
            {/* Export */}

        ...
        <div className="bg-[#008080] p-4 border-2 border-black rounded h-1/3 gap-4 flex flex-col justify-between ">
          <div className="h-2/3">
            <div className="flex flex-row justify-between items-center h-1/3">
              <p className="text-[#00FFA3] m-0">Case Details : </p>
          ...
          <TimerComponent className="h-1/3" />
        </div>
        {/* bottom container */}
        <div className="bg-[#008080] p-4 h-full border-2 border-black rounded flex flex-col justify-between">

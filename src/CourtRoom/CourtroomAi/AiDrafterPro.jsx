  ...
  const handleEditDoc = async () => {
    ...
    try {
      const props = await fetch(
        `${NODE_API_ENDPOINT}/courtroomPricing/api/edit_pro_application`,
        {
          method: "POST",
          headers: {
      ...
      <div className="border-2 border-black h-full bg-[#D9D9D9] rounded-md">
        <div className="py-3 h-full flex flex-col gap-2">
          <div className="px-3 flex justify-between">
            <p className="sm:ml-0 ml-5 text-xl  font-bold text-teal-700">
              AI Drafter
            </p>
            <Close
            ...
            <div className="bg-[#00808034] rounded-md h-full overflow-scroll">
              {drafterText ? (
                ...
                <div className="h-full flex flex-col justify-center items-center gap-4">
                  ...
                  <div className="w-[30rem] text-teal-600 h-16 text-center">
                    <TipsComponent />
                  </div>
                </div>
              )}
            ...
            <div className="h-full bg-[#046162] rounded-md flex flex-col gap-2 p-2">
              ...
              <div className="flex gap-2 relative bg-white p-1 rounded-md">
                ...
                <button
                  ...
                  className="py-1 px-4 bg-[#008080] hover:bg-teal-500 rounded-md text-sm text-white">
                  Send
                </button>
              </div>
            </div>
          ...
          <div className="flex justify-end px-2">
            <button
              ...
              className="border-2 border-teal-700 hover:bg-teal-500 rounded-md px-3 py-2 text-black">
              Download Document
            </button>
          </div>
        </div>

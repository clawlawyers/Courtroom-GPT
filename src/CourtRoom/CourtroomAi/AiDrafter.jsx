      ...
      <div className="border-2  border-black h-full bg-[#D9D9D9] rounded-md">
        <div className="py-3  h-full flex flex-col gap-2">
          ...
          <div className="flex-1 grid sm:grid-cols-[65%_35%] grid-cols-1 gap-2 px-3 h-[80%]">
            <div className="bg-[#00808034] rounded-md sm:h-full h-[90%] overflow-scroll">
              {drafterText ? (
                <p
            ...
            <div className="h-full bg-[#046162] rounded-md flex flex-col gap-2 p-2">
              ...
              <div className="flex gap-2 relative bg-white p-1 rounded-md">
                ...
                <button
                  ...
                  className="py-1 px-4 bg-[#008080]  hover:bg-[#3d6666]   hover:text-black rounded-md text-sm text-white">
                  Send
                </button>
              </div>
            </div>
          ...
          <div className="flex justify-end px-2">
            <button
              ...
              className="border-2 border-teal-700  hover:bg-white hover:bg-opacity-50 hover:text-white rounded-md px-3 py-2 text-black">
              Download Document
            </button>
          </div>
        </div>
